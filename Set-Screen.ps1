...
if ($Clear)
{
    Write-Host "Clearing lock screen image registry keys"
    New-ItemProperty -Path $RegKeyPath -Name $LockScreenStatus -Value 0 -Force | Out-Null
    New-ItemProperty -Path $RegKeyPath -Name $LockScreenPath -Value "" -Force | Out-Null
    New-ItemProperty -Path $RegKeyPath -Name $LockScreenUrl -Value "" -Force | Out-Null
}
else
{
